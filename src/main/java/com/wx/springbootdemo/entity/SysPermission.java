...
public class SysPermission {
    ...
    public SysPermission(Integer id, Integer available, String name, Long parentId, String parentIds, String permission, String resourceType, String url, String icon) {
        this.id = id;
